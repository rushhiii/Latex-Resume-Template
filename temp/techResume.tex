...
% \usepackage{newtxtext,newtxmath} % Use CMU-like serif font
...
\begin{center}
    ...
    % 8 Delpot Cl, Brampton, ON, L6P 3T3 \\ \vspace{1pt}
    % \faPhone\ 780-695-0133 ~
    ...
    \vspace{0pt} % do -15 for less space in between
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
        ...
        % {Bachelor of Computer Engineering $|$ Minor Artificial Intelligence}{Toronto, ON}
        % \resumeItemListStart
        % \resumeItem{Golden Key Honours Scholar $|$ \textbf{GPA: 3.78$/$4.0}}
        % \resumeItemListEnd
...
%                 \item Computer Architecture
%                 \item Assembly \& Machine Code
%                 \item Boolean Logic \& Circuits
%                 \item Algorithms \& Pseudocode
...
\section{Projects \& Experience}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\textbf{GitHub Stats \& Heatmap Widget} $|$ \href{https://github.com/rushhiii/Scriptable-IOSWidgets/tree/main/GitHubStats\%20Widget}{\emph{Source Code}}}{JS $|$ Scriptable $|$ GitHub API}
        \resumeItemListStart
          \resumeItem{Developed a fully featured GitHub widget for iOS using Scriptable, displaying contributions, commits, PRs, issues, stars, and much more. Integrated with GitHub \textbf{GraphQL} + \textbf{REST APIs} with secure token handling via Keychain.}
          \resumeItem{designed and Implemented 10+ dynamic visual themes (e.g., nord, gitgreen) and adaptive layouts for all widget sizes, with a support for customizable parameters (e.g., \texttt{repo,stat,theme}).}
        \resumeItemListEnd 
        \vspace{-13pt}
        \resumeProjectHeading
            {\textbf{Portfolio Website} $|$ \href{https://rushii-portfolio.netlify.app/}{\emph{Website}} $|$ \href{https://github.com/rushhiii/portfolio/}{\emph{Source Code}}}{HTML5 $|$ CSS3 $|$ JavaScript}
            \resumeItemListStart
                \resumeItem{Built and deployed a fully responsive and accessible portfolio with \textbf{HTML5}, \textbf{CSS3 Grid/Flexbox}, and \textbf{vanilla JS}, including smooth animations, dark/light theme toggle, and contact form.}
                \resumeItem{Hosted via \textbf{Netlify} with form handling and CI/CD integration at \href{https://rushii-portfolio.netlify.app}{\texttt{rushii-portfolio.netlify.app}}.}
        \resumeItemListEnd
        \vspace{-13pt}
      % \resumeProjectHeading
      %   {\textbf{Bashfolio} $|$ \href{https://rushi-bashfolio.netlify.app/}{\emph{Website}} $|$ \href{https://github.com/rushhiii/Rushi-Bashfolio}{\emph{Source Code}}}{HTML $|$ CSS $|$ JS}
      %   \resumeItemListStart
      %     \resumeItem{Built a terminal-style web portfolio, which mimics a Bash shell with keyboard navigation and typing animations.}
      %     \resumeItem{deployed via \textbf{Netlify} at \href{https://rushi-bashfolio.netlify.app}{\texttt{rushi-bashfolio.netlify.app}}, support for command-style routing (e.g., \texttt{socials}, \texttt{about}) and animated prompt UI.}
      %   \resumeItemListEnd 
      %   \vspace{-13pt}
      \resumeProjectHeading
        {\textbf{McNally High School Website Redesign} $|$ \href{http://www.rushi.42web.io/index.html}{\emph{Demo Site}}}{UI/UX $|$ Web Design $|$ HTML/CSS/JS}
        \resumeItemListStart
          \resumeItem{Redesigned original school website and built fully responsive site with improve \textbf{UI/UX}, \textbf{visual hierarchy}, and \textbf{accessibility}, enhancing clarity and ease of navigation for students and parents.}
          \resumeItem{Used clean \textbf{HTML/CSS layout}, consistent color themes, and mobile-friendly design principles; project still remains archived on the school’s server.}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-16pt}
...
% \begin{itemize}[leftmargin=0.15in, label={}]
%     \small{\item{ 
%     \textbf{Programming Languages:} JavaScript, Java, Python, HTML5, CSS \\
%     \textbf{Frameworks \& Libraries:} React, Node.js, Svelte, Flutter, WordPress \\ 
%     \textbf{Tools \& Technologies:} Git, Firebase, VS Code, IntelliJ, PyCharm, Excel, PowerPoint \\
%     \textbf{Soft Skills:} Leadership, Problem Solving, Communication, Initiative, Attention to Detail \\
%     }}
% \end{itemize}
% \vspace{-16pt}
